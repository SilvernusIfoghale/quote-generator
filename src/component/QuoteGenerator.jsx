        ...
        <div className=" bg-gray-100 border-2 h-[480px] w-[400px] rounded-2xl flex flex-col justify-between p-2">
          ...
          <div className="flex justify-around items-center">
            <select
              ...
              className="appearance-none bg-blue-200 p-2 px-3 rounded-lg mb-2 outline-none w-[170px] bg-[url('../../public/icon-down.png')] bg-no-repeat bg-right bg-[145px] font-semibold "
            >
